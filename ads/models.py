...
class Ad(models.Model):
    ...
    vehicle_make = models.ForeignKey(VehicleMake, on_delete=models.PROTECT, null=True)
    ...
    featured_image = models.ImageField(blank=True, null=True, upload_to='ads/', default='ads/ad-default.jpg')
